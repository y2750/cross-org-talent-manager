...
/** 此处后端没有提供注释 POST /user/toggle */
export async function toggleUserStatus(body: API.DeleteRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>('/user/toggle', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
